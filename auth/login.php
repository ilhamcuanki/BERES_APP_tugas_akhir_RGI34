...
<head>
  ...
  <style>
    ...
    *{margin:0;padding:0;box-sizing:border-box} body{font-family:'Inter',sans-serif;background:var(--bg);color:var(--text-main);line-height:1.6;min-height:100vh;display:flex;align-items:center;justify-content:center;padding:2rem}
    ...
    .form-group{margin-bottom:1.2rem} .form-label{display:block;margin-bottom:0.4rem;font-weight:500;font-size:0.9rem}
    ...
    .input-wrap input{width:100%;padding:0.75rem 0.75rem 0.75rem 2.4rem;border:1.5px solid var(--border);border-radius:var(--radius);font-size:0.95rem;transition:0.2s;background:#fafbfc}
    .input-wrap input:focus{outline:none;border-color:var(--primary-light);background:#fff}
...
<body>
  <div class="auth-card">
    <div class="auth-header">
      <h1><i class="fa-solid fa-right-to-bracket" style="color:var(--primary);margin-right:0.4rem"></i> Masuk</h1>
